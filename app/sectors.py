    ...
    "healthcare": {
        ...
        "categories":  [
            ("Diagnostic Equipment", "#0e7490", [
                ("Device Type",   "device_type",  "text", "e.g. MRI, CT, Ultrasound",  1),
            ...
            ("Surgical Equipment", "#be123c", [
                ("Equipment Type",    "equipment_type",    "text", "e.g. Laparoscope, Retractor",   1),
                ("Sterilization",     "sterilization",     "text", "e.g. Autoclave, EtO Gas",       0),
                ("Last Sterilized",   "last_sterilized",   "text", "YYYY-MM-DD",                    0),
            ]),
            ("Patient Monitoring", "#0369a1", [
                ("Device Type",  "device_type",  "text",     "e.g. Vitals Monitor, ECG, SpO2", 1),
                ("Has Wireless", "has_wireless",  "checkbox", "",                               0),
            ]),
            ("Infusion / IV Pumps", "#059669", [
                ("Device Type", "device_type", "text", "e.g. IV Pump, Syringe Driver", 1),
                ("Flow Rate",   "flow_rate",   "text", "e.g. 0.1–999 mL/hr",          0),
            ]),
            ("Mobility / Rehab", "#7c3aed", [
                ("Equipment Type",  "equipment_type", "text", "e.g. Wheelchair, Walker, Crutches", 1),
                ("Weight Capacity", "weight_capacity","text", "e.g. 300 lbs",                      0),
                ("Size",            "size",           "text", "e.g. Standard, Bariatric",           0),
            ]),
            ("Lab Equipment", "#0f766e", [
                ("Equipment Type", "equipment_type", "text", "e.g. Centrifuge, Analyzer, Incubator", 1),
                ("Capacity",       "capacity",       "text", "e.g. 24-sample",                       0),
            ]),
            ...
            ("Furniture / Fixtures", "#92400e", [
                ("Item Type",       "item_type",       "text", "e.g. Hospital Bed, Gurney, IV Stand", 1),
                ("Weight Capacity", "weight_capacity", "text", "e.g. 450 lbs",                        0),
                ("Room / Ward",     "location",        "text", "e.g. ICU, Ward 3B",                   0),
            ]),
            ("Accessories", "#6b7280", []),
        ],
    },
