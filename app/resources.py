RESOURCE_GUIDES = {
    ...
    "how-it-teams-track-inventory-across-locations": {
        ...
        "meta_description": "See how IT teams track laptops, network gear, accessories, and stock across multiple locations with CountDepot.",
        "eyebrow": "Workflow",
    ...
    "what-to-look-for-in-inventory-management-software": {
        ...
        "meta_description": "Use this buyer guide to compare barcode scanning, reservations, locations, permissions, and reporting in inventory software.",
        "eyebrow": "Buyer Guide",
...
def resource_page_for_slug(slug):
    return RESOURCE_GUIDES.get((slug or "").strip("/"))
